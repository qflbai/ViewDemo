...
package com.qflbai.view.materialmenu;
...
import static com.qflbai.view.materialmenu.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.qflbai.view.materialmenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.qflbai.view.materialmenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.qflbai.view.materialmenu.MaterialMenuDrawable.DEFAULT_VISIBLE;
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    @Override
    public void setIconState(MaterialMenuDrawable.IconState state) {
        currentState = state;
    ...
    @Override
    public void animateIconState(MaterialMenuDrawable.IconState state) {
        currentState = state;
    ...
    @Override
    public MaterialMenuDrawable.IconState setTransformationOffset(MaterialMenuDrawable.AnimationState animationState, float value) {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcel in) {
            super(in);
            state = MaterialMenuDrawable.IconState.values()[in.readInt()];
