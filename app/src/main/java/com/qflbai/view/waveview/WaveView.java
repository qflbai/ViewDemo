...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#28FFFF00");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3C00FFFF");
